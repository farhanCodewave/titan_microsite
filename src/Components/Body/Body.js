...
function Body() {
  ...
  const scrollTo = (id) => {
    ...
    switch (id) {
      case "1":
        return ref1.current.scrollIntoView();
      case "2":
        return ref2.current.scrollIntoView();
      case "3":
        return ref3.current.scrollIntoView();
      case "4":
        return ref4.current.scrollIntoView();
      default:
        return ref1.current.scrollIntoView();
    }
  };
  ...
  return (
    <>
      <Header />
      <div className="body1   " id="About" ref={ref1}>
        ...
        <div className="body1-para">
          <p className="text-center para">
            Mr.C K Venkataraman - Managing Director - Titan Company Ltd, on
      ...
      <div className="body2 ">
        ...
        <div id="sponsorATree" ref={ref2}>
                ...
                <div className="contribute-form">
                  ...
                  <form class="form-group" onSubmit={handleFormSubmit}>
                    ...
                    >
                      ...
                      <Modal.Body>
                        Please scan the below QR Code or enter the UPI ID and
                        complete the transaction from your mobile Apps.
                      </Modal.Body>
                      <Modal.Body>
                        <div className="upi-cont">
                          <div className="upi">
                            <p>UPI ID: biotasoilfoundation@IOB</p>
                          </div>
                          <img src={scan} className="upi-img"></img>
                        </div>
                      </Modal.Body>
                      {/* <Modal.Footer>
          ...
          Confirm
                  ...
                  <div>
                    <p className="extra">
                      For Contribution of more than 250 Trees{" "}
                      <button onClick={handleShow1}>Click here</button>
                      <Modal
                        class=".modal-fullscreen-sm-down"
                        show={show1}
                        onHide={handleClose1}
                      ...
                      >
                        ...
                        <Modal.Footer>
                          <Button className="btn-7" onClick={handleClose1}>
                            Confirm
                          </Button>
                        </Modal.Footer>
                      </Modal>
      ...
      <div className="bg-video-wrap" id="joinTheRun" ref={ref3}>
          ...
          <div className="video-content">
            <div className="row">
              <div className="col-md-6 india-cont">
                <a
                  target="_blank"
                  href="https://hdor.com/app/#/titan-user-login"
                >
      ...
      <div className="body4 container ">
        ...
        <div>
          <div className="row " id="takeThePledge" ref={ref4}>
            <div className="wrapper-body4">
              ...
              <div className="col-md-6 wrapper-body41">
                ...
                <button className="btn4">
                  <a
                    target="_blank"
                    href="https://res.cloudinary.com/dvli2yrzi/image/upload/v1662112662/Titan_Pledge__A4.pdf"
                  >
                    See The Pledges
                  </a>
                </button>
